...
//    var toDoNotesArray = ["I should be certain to do all of the exercises at the end of the chapters before the exam.", "Take my ideas to the school's venture competition and win the big check.", "Foxus apps on empowerment for all, with an extra bonus for users who are kind."]
